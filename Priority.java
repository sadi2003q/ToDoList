...
public class Priority {
    ...
    public void ChangeToSchedule(Event e) throws IOException {
    ...
    public static EventHandler<MouseEvent> redCircleHandler(HBox hbox, AnchorPane main, Priority controller, FlowPane flowPane, double currentPosition){
        return mouseEvent -> {
    ...
    public void showToCanvas() {
        ...
        if((taskInfo.get(2)).equalsIgnoreCase("PRIORITY")){
