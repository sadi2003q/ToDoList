...
public class Page1 {
    ...
    @FXML
    private Button ChangeToCOmplete;
    @FXML
    ...
    public static EventHandler<MouseEvent> redCircleHandler(HBox hbox, AnchorPane main, Page1 controller, FlowPane flowPane, double currentPosition){
        return mouseEvent -> {
